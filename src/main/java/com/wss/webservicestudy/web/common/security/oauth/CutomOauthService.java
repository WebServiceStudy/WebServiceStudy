...
@Service
public class CutomOauthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {

    private UserRepository userRepository;
    private HttpSession httpSession;

    public CutomOauthService(UserRepository userRepository, HttpSession httpSession) {
